...
## → v33.0.0 — response metadata is not column data; pagination arithmetic moved to `CNIC\Paginator`; `Column::$length` is an accessor; the template registry publishes two contracts
